export const initProjects = [
  ...
  },
  {
    ...
    name: 'Star Wars',
    link: "https://dimitry-prog.github.io/starWars__React/",
  ...
  },
  {
    ...
    codeLink: 'https://github.com/Dimitry-prog/ToDo__React',
    description: 'Implementation of the list in React. It is possible to add, delete and edit tasks. They are also saved if you want to return to the to-do list later.',
    stack: [
      "React", "Module CSS3", "GIT",
    ],
  },
]